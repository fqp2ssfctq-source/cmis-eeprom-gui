...
_P02H_DESC = {
    0: ("온도 High Alarm",   "S16/256 °C"),
    2: ("온도 Low Alarm",    "S16/256 °C"),
    4: ("온도 High Warning", "S16/256 °C"),
    6: ("온도 Low Warning",  "S16/256 °C"),
    8: ("Vcc High Alarm",    "U16×100µV→V"),
   10: ("Vcc Low Alarm",     "U16×100µV→V"),
   12: ("Vcc High Warning",  "U16×100µV→V"),
   14: ("Vcc Low Warning",   "U16×100µV→V"),
   16: ("Aux1 High Alarm",   "S16 TEC전류/Custom"),
   18: ("Aux1 Low Alarm",    "S16"),
   20: ("Aux1 High Warning", "S16"),
   22: ("Aux1 Low Warning",  "S16"),
   24: ("Aux2 High Alarm",   "S16 TEC전류/레이저온도"),
   26: ("Aux2 Low Alarm",    "S16"),
   28: ("Aux2 High Warning", "S16"),
   30: ("Aux2 Low Warning",  "S16"),
   32: ("Aux3 High Alarm",   "S16 레이저온도/추가전압"),
   34: ("Aux3 Low Alarm",    "S16"),
   36: ("Aux3 High Warning", "S16"),
   38: ("Aux3 Low Warning",  "S16"),
   40: ("Custom High Alarm",   "S16/U16"),
   42: ("Custom Low Alarm",    "S16/U16"),
   44: ("Custom High Warning", "S16/U16"),
   46: ("Custom Low Warning",  "S16/U16"),
   48: ("Tx Power High Alarm",   "U16×0.1µW→dBm"),
   50: ("Tx Power Low Alarm",    "U16×0.1µW→dBm"),
   52: ("Tx Power High Warning", "U16×0.1µW→dBm"),
   54: ("Tx Power Low Warning",  "U16×0.1µW→dBm"),
   56: ("Tx Bias High Alarm",   "U16×2µA"),
   58: ("Tx Bias Low Alarm",    "U16×2µA"),
   60: ("Tx Bias High Warning", "U16×2µA"),
   62: ("Tx Bias Low Warning",  "U16×2µA"),
   64: ("Rx Power High Alarm",   "U16×0.1µW→dBm"),
   66: ("Rx Power Low Alarm",    "U16×0.1µW→dBm"),
   68: ("Rx Power High Warning", "U16×0.1µW→dBm"),
   70: ("Rx Power Low Warning",  "U16×0.1µW→dBm"),
    72: ("Lane Tx Power High Alarm",   "U16×0.1µW→dBm"),
    74: ("Lane Tx Power Low Alarm",    "U16×0.1µW→dBm"),
    76: ("Lane Tx Power High Warning", "U16×0.1µW→dBm"),
    78: ("Lane Tx Power Low Warning",  "U16×0.1µW→dBm"),
    80: ("Lane Tx Bias High Alarm",    "U16×2µA"),
    82: ("Lane Tx Bias Low Alarm",     "U16×2µA"),
    84: ("Lane Tx Bias High Warning",  "U16×2µA"),
    86: ("Lane Tx Bias Low Warning",   "U16×2µA"),
    88: ("Lane Rx Power High Alarm",   "U16×0.1µW→dBm"),
    90: ("Lane Rx Power Low Alarm",    "U16×0.1µW→dBm"),
    92: ("Lane Rx Power High Warning", "U16×0.1µW→dBm"),
    94: ("Lane Rx Power Low Warning",  "U16×0.1µW→dBm"),
    96: ("Reserved", "—"),
...
def parse_txt(text):
    ...
    for line in text.strip().splitlines():
        ...
        if len(p)>2:
            ...
            # P03h는 하위 호환성을 위해 마지막 열에 배치 (구 파일: col8 없음 → 0 유지)
            for ki,pk in enumerate(["p00","p01","p02","p10","p11","p03"]):
                col=3+ki
...
def parse_xlsx(path):
    ...
    for row in ws.iter_rows(min_row=2,values_only=True):
        ...
        if len(row)>1 and row[1] is not None:
            try: data["a0"][a]=int(str(row[1]).strip(),16)
            except: pass
...
class CanvasTable(tk.Frame):
    ...
    def _start_inline_edit(self, ri, event=None):
        ...
        if event is not None:
            ...
            ry_row  = self.HEAD_H + ri*self.ROW_H - self._scroll_y
            rx  = self._cv.winfo_rootx() + col2_x
            ry2 = self._cv.winfo_rooty() + ry_row + self.ROW_H
        # Toplevel 팝업 생성
...
class App(tk.Tk):
    ...
    def _get_rows(self,pk):
        ...
        if pk=="a0":
            defs=[
                ...
                (26,1,"ModuleControls"),
                (27,1,"ModuleFaultCause"),
                (28,8,"Reserved[1C~23h]"),
                (36,1,"Reserved[24h]"),
                (37,1,"CdbStatus1"),(38,1,"CdbStatus2"),
                (39,2,"ActiveFWVersion"),
                (41,1,"LaneFlags[Tx]"),(42,1,"LaneFlags[Rx]"),
                (43,8,"TxFaultFlags[Lane1~8]"),
                (51,8,"RxFaultFlags[Lane1~8]"),
                (59,1,"Reserved[3B]"),(60,5,"Reserved[3C~40h]"),
                (65,1,"TxDisableStatus"),(66,1,"RxOutputDisableStatus"),
                (67,1,"TxForcedSquelchStatus"),(68,4,"Reserved[44~47h]"),
                (72,8,"TxBiasMon[Lane1~8]"),
                (80,4,"AppDescSelector[Lane1~4]"),
                (84,1,"AppDescSelector[Lane5~8]"),
            ...
            defs=[
                ...
                (76,8,"MediaLanes[App0~7]"),
                (84,1,"MediaInterfaceTech"),
            ...
            defs=[
                ...
                (39,2,"T_init[ms]"),(41,2,"T_reset[ms]"),
                (43,2,"T_resetInit[ms]"),(45,2,"T_lpInit[ms]"),
                (47,2,"T_hpInit[ms]"),(49,2,"T_txTurnOn[ms]"),
                (51,2,"T_txTurnOff[ms]"),
                (53,2,"T_rxTurnOn[ms]"),(55,2,"T_rxTurnOff[ms]"),
                (57,2,"T_txDisableToLos[ms]"),(59,4,"CDB_Advertisement"),
                (63,1,"Reserved[BF]"),
                (64,8,"MediaLaneCharacteristics[Lane1~8]"),
                (72,8,"MediaLaneFlags[Lane1~8]"),
                (80,16,"SICtrlAdv[TX]"),(96,16,"SICtrlAdv[RX]"),
                (112,15,"Reserved[EF~FD]"),
                (127,1,"PageChecksum"),
            ]
        elif pk=="p03":
            defs=[
                (0,2,"Reserved[80~81h]"),
                (2,2,"TxPowerLane1"),(4,2,"TxPowerLane2"),
                (6,2,"TxPowerLane3"),(8,2,"TxPowerLane4"),
                (10,2,"TxPowerLane5"),(12,2,"TxPowerLane6"),
                (14,2,"TxPowerLane7"),(16,2,"TxPowerLane8"),
                (18,2,"RxPowerLane1"),(20,2,"RxPowerLane2"),
                (22,2,"RxPowerLane3"),(24,2,"RxPowerLane4"),
                (26,2,"RxPowerLane5"),(28,2,"RxPowerLane6"),
                (30,2,"RxPowerLane7"),(32,2,"RxPowerLane8"),
                (34,2,"TxBiasLane1"),(36,2,"TxBiasLane2"),
                (38,2,"TxBiasLane3"),(40,2,"TxBiasLane4"),
                (42,2,"TxBiasLane5"),(44,2,"TxBiasLane6"),
                (46,2,"TxBiasLane7"),(48,2,"TxBiasLane8"),
                (50,2,"TxSNRLane1"),(52,2,"TxSNRLane2"),
                (54,2,"TxSNRLane3"),(56,2,"TxSNRLane4"),
                (58,2,"TxSNRLane5"),(60,2,"TxSNRLane6"),
                (62,2,"TxSNRLane7"),(64,2,"TxSNRLane8"),
                (66,61,"Reserved[B2~F2h]"),
                (127,1,"PageChecksum"),
            ]
        elif pk=="p02":
            defs=[
                ...
                # Per-Lane Thresholds (Lane 1~8)
                (72,2,"LaneTxPwrHighAlarm"),(74,2,"LaneTxPwrLowAlarm"),
                (76,2,"LaneTxPwrHighWarning"),(78,2,"LaneTxPwrLowWarning"),
                (80,2,"LaneTxBiasHighAlarm"),(82,2,"LaneTxBiasLowAlarm"),
                (84,2,"LaneTxBiasHighWarning"),(86,2,"LaneTxBiasLowWarning"),
                (88,2,"LaneRxPwrHighAlarm"),(90,2,"LaneRxPwrLowAlarm"),
                (92,2,"LaneRxPwrHighWarning"),(94,2,"LaneRxPwrLowWarning"),
                (96,31,"Reserved[E0~FE]"),
                (127,1,"PageChecksum"),
            ]
        elif pk=="p10":
            defs=[
                (0,1,"DataPathDeinitLane[8:1]"),
                (1,1,"TxDisableLane[8:1]"),
                (2,1,"TxForcedSquelchLane[8:1]"),
                (3,1,"TxPolInversionLane[8:1]"),
                (4,1,"RxOutputDisableLane[8:1]"),
                (5,1,"RxOutputPolInversionLane[8:1]"),
                (6,2,"Reserved[8Eh~8Fh]"),
                (8,1,"OutputAmplitudeCtrl Lane1"),(9,1,"OutputAmplitudeCtrl Lane2"),
                (10,1,"OutputAmplitudeCtrl Lane3"),(11,1,"OutputAmplitudeCtrl Lane4"),
                (12,1,"OutputAmplitudeCtrl Lane5"),(13,1,"OutputAmplitudeCtrl Lane6"),
                (14,1,"OutputAmplitudeCtrl Lane7"),(15,1,"OutputAmplitudeCtrl Lane8"),
                (16,1,"OutputPreCursorCtrl Lane1"),(17,1,"OutputPreCursorCtrl Lane2"),
                (18,1,"OutputPreCursorCtrl Lane3"),(19,1,"OutputPreCursorCtrl Lane4"),
                (20,1,"OutputPreCursorCtrl Lane5"),(21,1,"OutputPreCursorCtrl Lane6"),
                (22,1,"OutputPreCursorCtrl Lane7"),(23,1,"OutputPreCursorCtrl Lane8"),
                (24,1,"OutputPostCursorCtrl Lane1"),(25,1,"OutputPostCursorCtrl Lane2"),
                (26,1,"OutputPostCursorCtrl Lane3"),(27,1,"OutputPostCursorCtrl Lane4"),
                (28,1,"OutputPostCursorCtrl Lane5"),(29,1,"OutputPostCursorCtrl Lane6"),
                (30,1,"OutputPostCursorCtrl Lane7"),(31,1,"OutputPostCursorCtrl Lane8"),
                (32,1,"InputEqualizationCtrl Lane1"),(33,1,"InputEqualizationCtrl Lane2"),
                (34,1,"InputEqualizationCtrl Lane3"),(35,1,"InputEqualizationCtrl Lane4"),
                (36,1,"InputEqualizationCtrl Lane5"),(37,1,"InputEqualizationCtrl Lane6"),
                (38,1,"InputEqualizationCtrl Lane7"),(39,1,"InputEqualizationCtrl Lane8"),
                (40,1,"RxCDRBypassLane[8:1]"),
                (41,1,"TxCDRBypassLane[8:1]"),
                (42,2,"Reserved[AAh~ABh]"),
                (44,83,"Reserved[ACh~FEh]"),
                (127,1,"PageChecksum"),
            ]
        elif pk=="p11":
            defs=[
                (0,1,"AppSelLane1"),(1,1,"AppSelLane2"),
                (2,1,"AppSelLane3"),(3,1,"AppSelLane4"),
                (4,1,"AppSelLane5"),(5,1,"AppSelLane6"),
                (6,1,"AppSelLane7"),(7,1,"AppSelLane8"),
                (8,1,"DataPathCtrlLane1"),(9,1,"DataPathCtrlLane2"),
                (10,1,"DataPathCtrlLane3"),(11,1,"DataPathCtrlLane4"),
                (12,1,"DataPathCtrlLane5"),(13,1,"DataPathCtrlLane6"),
                (14,1,"DataPathCtrlLane7"),(15,1,"DataPathCtrlLane8"),
                (16,1,"OutputAmplitudeCtrl[SCS] Lane1"),(17,1,"OutputAmplitudeCtrl[SCS] Lane2"),
                (18,1,"OutputAmplitudeCtrl[SCS] Lane3"),(19,1,"OutputAmplitudeCtrl[SCS] Lane4"),
                (20,1,"OutputAmplitudeCtrl[SCS] Lane5"),(21,1,"OutputAmplitudeCtrl[SCS] Lane6"),
                (22,1,"OutputAmplitudeCtrl[SCS] Lane7"),(23,1,"OutputAmplitudeCtrl[SCS] Lane8"),
                (24,2,"Reserved[98h~99h]"),
                (26,1,"OutputPreCursorCtrl[SCS] Lane1"),(27,1,"OutputPreCursorCtrl[SCS] Lane2"),
                (28,1,"OutputPreCursorCtrl[SCS] Lane3"),(29,1,"OutputPreCursorCtrl[SCS] Lane4"),
                (30,1,"OutputPreCursorCtrl[SCS] Lane5"),(31,1,"OutputPreCursorCtrl[SCS] Lane6"),
                (32,1,"OutputPreCursorCtrl[SCS] Lane7"),(33,1,"OutputPreCursorCtrl[SCS] Lane8"),
                (34,1,"OutputPostCursorCtrl[SCS] Lane1"),(35,1,"OutputPostCursorCtrl[SCS] Lane2"),
                (36,1,"OutputPostCursorCtrl[SCS] Lane3"),(37,1,"OutputPostCursorCtrl[SCS] Lane4"),
                (38,1,"OutputPostCursorCtrl[SCS] Lane5"),(39,1,"OutputPostCursorCtrl[SCS] Lane6"),
                (40,1,"OutputPostCursorCtrl[SCS] Lane7"),(41,1,"OutputPostCursorCtrl[SCS] Lane8"),
                (42,1,"InputEqualizationCtrl[SCS] Lane1"),(43,1,"InputEqualizationCtrl[SCS] Lane2"),
                (44,1,"InputEqualizationCtrl[SCS] Lane3"),(45,1,"InputEqualizationCtrl[SCS] Lane4"),
                (46,1,"InputEqualizationCtrl[SCS] Lane5"),(47,1,"InputEqualizationCtrl[SCS] Lane6"),
                (48,1,"InputEqualizationCtrl[SCS] Lane7"),(49,1,"InputEqualizationCtrl[SCS] Lane8"),
                (50,9,"Reserved[B2h~BAh]"),
                (59,1,"RxCDRBypass[SCS] Lane1"),(60,1,"RxCDRBypass[SCS] Lane2"),
                (61,1,"RxCDRBypass[SCS] Lane3"),(62,1,"RxCDRBypass[SCS] Lane4"),
                (63,1,"RxCDRBypass[SCS] Lane5"),(64,1,"RxCDRBypass[SCS] Lane6"),
                (65,1,"RxCDRBypass[SCS] Lane7"),(66,1,"RxCDRBypass[SCS] Lane8"),
                (67,11,"Reserved[C3h~CDh]"),
                (78,4,"Reserved[CEh~D1h]"),
                (82,12,"Reserved[D2h~DDh]"),
                (94,34,"Reserved[DEh~FFh]"),
                (127,1,"PageChecksum"),
            ]
        else:
            base=0x80
    ...
    def _desc_a0(self,v,i):
        ...
        if i==1:  return f"CMIS 규격 버전 (상위4=Major, 하위4=Minor) | 현재 참조: {SPEC_CMIS}"
        ...
        if i==26: return "모듈 전역 제어 비트 (LowPwr/Squelch/Reset)"
        if i==27: return "모듈 장애 원인 코드 (CMIS 5.0+)"
        if i==37: return "CDB 인스턴스1 명령 상태"
        if i==38: return "CDB 인스턴스2 명령 상태"
        if i==39: return "현재 활성 펌웨어 버전"
        if i==65: return "Tx Lane별 Disable 상태 (Bit=Lane)"
        if i==66: return "Rx Lane별 출력 Disable 상태"
        if i==67: return "Tx Lane별 Forced Squelch 상태"
        if i==72: return "Tx Bias Monitor [Lane1~4] (U16×2µA)"
        for ap in range(8):
            if i==85+ap*4: return f"AppDescriptor[{ap}] Host/Media Interface 식별자"
        if i==117: return "DataPath Config per Lane (AppSel Code)"
    ...
    def _desc_p00(self,v,i):
        ...
        if i==75: return "커넥터 타입 (SFF-8024 Table 4-3)"
        if i==76: return "Media Lane 수 per AppDescriptor (CMIS 5.0+, App0~7)"
        if i==84: return "미디어 인터페이스 기술 (레이저 파장/종류)"
        for ap,(ai) in enumerate([85,89,95,99,103,107,111,115]):
            if i==ai: return f"AppDescriptor[{ap}]: Host/Media IF ID + Lane 수/Assign"
        if i==93: return "Reserved"
        if i==94: return "Page 00h 체크섬 (Byte 128~221 합산 mod256)"
        if i==119: return "Reserved"
        return ""
    ...
    def _desc_p01(self,i):
        ...
        if i==39: return "T_init: 전원 인가 후 모듈 준비 완료 최대 시간 (ms)"
        if i==41: return "T_reset: ResetL 해제 후 준비 완료 최대 시간 (ms)"
        if i==43: return "T_resetInit: MgmtInit 상태 최대 유지 시간 (ms)"
        if i==45: return "T_lpInit: LowPwr → Init 전환 최대 시간 (ms)"
        if i==47: return "T_hpInit: HighPwr Init 시간 (ms)"
        if i==49: return "T_txTurnOn: Tx 활성화 최대 시간 (ms)"
        if i==51: return "T_txTurnOff: Tx 비활성화 최대 시간 (ms)"
        if i==53: return "T_rxTurnOn: Rx 활성화 최대 시간 (ms)"
        if i==55: return "T_rxTurnOff: Rx 비활성화 최대 시간 (ms)"
        if i==57: return "T_txDisToLos: TxDisable 후 LOS 발생 최대 시간 (ms)"
        if i==59: return "CDB 기능 광고 상세 (4바이트)"
        if i==64: return "Media Lane 특성 per Lane (Lane1~8)"
        if i==72: return "Media Lane Flags 지원 광고 per Lane (Lane1~8)"
        if i==80: return "SI Control 광고 [TX, 16바이트]"
        if i==96: return "SI Control 광고 [RX, 16바이트]"
        if i==112: return "Reserved"
    ...
    def _desc_p03(self,i):
        ...
        if 2<=i<=16 and i%2==0:
            lane=(i-2)//2+1
            return f"Tx Power Lane {lane} (U16×0.1µW→dBm, RO)"
        if 18<=i<=32 and i%2==0:
            lane=(i-18)//2+1
            return f"Rx Power Lane {lane} (U16×0.1µW→dBm, RO)"
        if 34<=i<=48 and i%2==0:
            lane=(i-34)//2+1
            return f"Tx Bias Lane {lane} (U16×2µA, RO)"
        if 50<=i<=64 and i%2==0:
            lane=(i-50)//2+1
            return f"Tx SNR Lane {lane} (U8.8 dB, RO)"
        if i==127: return "Page Checksum (Byte 128~254 합산 mod256)"
        return ""
    ...
    def _desc_p10(self,i):
        _LANE_CTRL={0:"DataPath Deinit per Lane (bit=Lane, 1=Deinit)",
                    1:"Tx Disable per Lane (1=Disable)",
                    2:"Tx Forced Squelch per Lane (1=Squelch)",
                    3:"Tx Polarity Inversion per Lane (1=Invert)",
                    4:"Rx Output Disable per Lane (1=Disable)",
                    5:"Rx Output Polarity Inversion per Lane (1=Invert)",
                    40:"Rx CDR Bypass per Lane (1=Bypass)",
                    41:"Tx CDR Bypass per Lane (1=Bypass)"}
        if i in _LANE_CTRL: return _LANE_CTRL[i]
        if 8<=i<=15:  return f"Tx Output Amplitude Control Lane{i-7} (4-bit, 0=min)"
        if 16<=i<=23: return f"Tx Pre-Cursor Control Lane{i-15} (5-bit signed)"
        if 24<=i<=31: return f"Tx Post-Cursor Control Lane{i-23} (5-bit signed)"
        if 32<=i<=39: return f"Rx Input Equalization Control Lane{i-31} (4-bit)"
        if i==127: return "Page Checksum (Byte 128~254 합산 mod256)"
        return ""
    ...
    def _desc_p11(self,i):
        if 0<=i<=7:   return f"AppSel Lane{i+1} (Host[7:4] / Media[3:0] Interface ID)"
        if 8<=i<=15:  return f"DataPath Control Lane{i-7} (FEC/CDR mode)"
        if 16<=i<=23: return f"Tx Output Amplitude Control[SCS] Lane{i-15}"
        if 26<=i<=33: return f"Tx Pre-Cursor Control[SCS] Lane{i-25}"
        if 34<=i<=41: return f"Tx Post-Cursor Control[SCS] Lane{i-33}"
        if 42<=i<=49: return f"Rx Input Equalization Control[SCS] Lane{i-41}"
        if 59<=i<=66: return f"Rx CDR Bypass[SCS] Lane{i-58}"
        if i==127: return "Page Checksum"
        return ""
