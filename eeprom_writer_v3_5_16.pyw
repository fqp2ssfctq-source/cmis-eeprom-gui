...
CHANGELOG = [
    ...
    ("3.5.16","2026-05-11","patch",  "ModuleControls idx 26: LowPwrHW→LowPwrAllowRequestHW, LowPwrSW→LowPwrRequestSW (CMIS 5.2 Table 8-11)"),
    ("3.5.16","2026-05-11","patch",  "_CMP_FIELD_A0: ModuleState/ModuleFaultCause/BankSelect/PageSelect 수정, _CMP_FIELD_P00: MediaConnectorType"),
    ("3.5.15","2026-05-11","patch",  "전 페이지 Field Name CMIS 5.2 공식 명칭 통일"),
...
_CMP_FIELD_A0 = {
    ...
    3:"ModuleState",
    4:"FlagsSummaryBank0",  5:"FlagsSummaryBank1",
    6:"FlagsSummaryBank2",  7:"FlagsSummaryBank3",
...
_CMP_FIELD_P00 = {
    ...
    **{i:"CLEICode"    for i in range(62,72)},
    ...
    74:"CableLinkLength",  75:"MediaConnectorType",
...
class App(tk.Tk):
    ...
    def _pw_unlock(self):
        ...
        try:
            ...
            self._log("  PW Addr : " + " ".join(f"{a:02X}h" for a in addrs))
            self._log("  PW Value: " + " ".join(f"{v:02X}h" for v in vals))
            # 4바이트를 각 주소에 순서대로 쓰기
    ...
    def _get_rows(self,pk):
        ...
        if pk=="a0":
            ...
            defs=[
                ...
                (40,1,"CDREnableRx"),
                (41,1,"CDREnableTx"),
                # ── SCS1 (Staged Control Set 1) ────────────────────────
                # CMIS 5.2 Table 8-69~73: bytes 178~212, idx 50~84
                (42,1,"SCS1::ApplyDPInit"),
                (43,1,"SCS1::ApplyImmediate"),
                (44,8,"SCS1::DPConfigLane [Lane1~8]"),
                (52,1,"SCS1::TxInputAmplitudeLane1"),(53,1,"SCS1::TxInputAmplitudeLane2"),
                (54,1,"SCS1::TxInputAmplitudeLane3"),(55,1,"SCS1::TxInputAmplitudeLane4"),
                (56,1,"SCS1::TxInputAmplitudeLane5"),(57,1,"SCS1::TxInputAmplitudeLane6"),
                (58,1,"SCS1::TxInputAmplitudeLane7"),(59,1,"SCS1::TxInputAmplitudeLane8"),
                (60,1,"SCS1::TxInputEqPreCursorLane1"),(61,1,"SCS1::TxInputEqPreCursorLane2"),
                (62,1,"SCS1::TxInputEqPreCursorLane3"),(63,1,"SCS1::TxInputEqPreCursorLane4"),
                (64,1,"SCS1::TxInputEqPreCursorLane5"),(65,1,"SCS1::TxInputEqPreCursorLane6"),
                (66,1,"SCS1::TxInputEqPreCursorLane7"),(67,1,"SCS1::TxInputEqPreCursorLane8"),
                (68,1,"SCS1::TxInputEqPostCursorLane1"),(69,1,"SCS1::TxInputEqPostCursorLane2"),
                (70,1,"SCS1::TxInputEqPostCursorLane3"),(71,1,"SCS1::TxInputEqPostCursorLane4"),
                (72,1,"SCS1::TxInputEqPostCursorLane5"),(73,1,"SCS1::TxInputEqPostCursorLane6"),
                (74,1,"SCS1::TxInputEqPostCursorLane7"),(75,1,"SCS1::TxInputEqPostCursorLane8"),
                (76,1,"SCS1::RxOutputEqLane1"),(77,1,"SCS1::RxOutputEqLane2"),
                (78,1,"SCS1::RxOutputEqLane3"),(79,1,"SCS1::RxOutputEqLane4"),
                (80,1,"SCS1::RxOutputEqLane5"),(81,1,"SCS1::RxOutputEqLane6"),
                (82,1,"SCS1::RxOutputEqLane7"),(83,1,"SCS1::RxOutputEqLane8"),
                (84,1,"SCS1::CDREnableRx"),
                # ── Lane-Specific Masks (bytes 213~232, idx 85~104) ────
                (85,20,"LaneSpecificMasks [0xD5~0xE8]"),
                # ── Reserved / Custom ──────────────────────────────────
                (105,22,"Reserved [0xE9~0xFE]"),
                (127,1,"PageChecksum"),
            ]
        elif pk=="p11":
            defs=[
                # ── Data Path States (bytes 128~131, idx 0~3) ──────────
                # 4 bits per lane, 2 lanes per byte
                (0,1,"DPStateHostLane [Lane2:Lane1]"),
                (1,1,"DPStateHostLane [Lane4:Lane3]"),
                (2,1,"DPStateHostLane [Lane6:Lane5]"),
                (3,1,"DPStateHostLane [Lane8:Lane7]"),
                # ── Lane Output Status (bytes 132~133, idx 4~5) ────────
                (4,1,"OutputStatusRx"),
                (5,1,"OutputStatusTx"),
                # ── Lane-Specific Flags (bytes 134~153, idx 6~25) ─────
                (6,1,"LOSFlagTx [Lane8:Lane1]"),
                (7,1,"LOSFlagRx [Lane8:Lane1]"),
                (8,1,"CDRLOLFlagTx [Lane8:Lane1]"),
                (9,1,"CDRLOLFlagRx [Lane8:Lane1]"),
                (10,8,"OpticalPowerHighAlarmFlagTx [Lane8:Lane1]"),
                (18,4,"OpticalPowerLowAlarmFlagTx [Lane8:Lane1]"),
                (22,1,"OutputStatusChangedFlagRx [Lane8:Lane1]"),
                (23,3,"Reserved [0x97~0x99]"),
                # ── Lane-Specific Monitors (bytes 154~201, idx 26~73) ──
                # Table 8-82: OpticalPowerTx1~8 (U16, 0.1µW)
                (26,2,"OpticalPowerTx1"),(28,2,"OpticalPowerTx2"),
                (30,2,"OpticalPowerTx3"),(32,2,"OpticalPowerTx4"),
                (34,2,"OpticalPowerTx5"),(36,2,"OpticalPowerTx6"),
                (38,2,"OpticalPowerTx7"),(40,2,"OpticalPowerTx8"),
                # Table 8-82: LaserBiasTx1~8 (U16, 2µA × multiplier)
                (42,2,"LaserBiasTx1"),(44,2,"LaserBiasTx2"),
                (46,2,"LaserBiasTx3"),(48,2,"LaserBiasTx4"),
                (50,2,"LaserBiasTx5"),(52,2,"LaserBiasTx6"),
                (54,2,"LaserBiasTx7"),(56,2,"LaserBiasTx8"),
                # Table 8-82: OpticalPowerRx1~8 (U16, 0.1µW)
                (58,2,"OpticalPowerRx1"),(60,2,"OpticalPowerRx2"),
                (62,2,"OpticalPowerRx3"),(64,2,"OpticalPowerRx4"),
                (66,2,"OpticalPowerRx5"),(68,2,"OpticalPowerRx6"),
                (70,2,"OpticalPowerRx7"),(72,2,"OpticalPowerRx8"),
                # ── ConfigStatus (bytes 202~205, idx 74~77) ───────────
                (74,1,"ConfigStatusLane [Lane2:Lane1]"),
                (75,1,"ConfigStatusLane [Lane4:Lane3]"),
                (76,1,"ConfigStatusLane [Lane6:Lane5]"),
                (77,1,"ConfigStatusLane [Lane8:Lane7]"),
                # ── Active Control Set (bytes 206~234, idx 78~106) ────
                (78,1,"ACS::DPConfigLane1"),(79,1,"ACS::DPConfigLane2"),
                (80,1,"ACS::DPConfigLane3"),(81,1,"ACS::DPConfigLane4"),
                (82,1,"ACS::DPConfigLane5"),(83,1,"ACS::DPConfigLane6"),
                (84,1,"ACS::DPConfigLane7"),(85,1,"ACS::DPConfigLane8"),
                (86,21,"ACS::TxControls [0xD6~0xEA]"),
                # ── Data Path Conditions (bytes 235~239, idx 107~111) ─
                (107,1,"DPInitPending [Lane8:Lane1]"),
                (108,4,"Reserved [0xEC~0xEF]"),
                # ── Media Lane Mapping (bytes 240~255, idx 112~127) ───
                (112,15,"MediaLaneMapping [0xF0~0xFE]"),
                (127,1,"PageChecksum"),
            ]
        else:
            base=0x80
    ...
    def _decoded_a0(self,v,i):
        ...
        if i==26:
            return (f"LowPwrAllowRequestHW={(v[26]>>6)&1} "
                    f"SquelchMethodSelect={(v[26]>>5)&1} "
                    f"LowPwrRequestSW={(v[26]>>4)&1} "
                    f"SoftwareReset={(v[26]>>3)&1}")
        if i==27:
            fc=v[27]&0x1F
    ...
    def _desc_a0(self,v,i):
        ...
        if i==26: return ("ModuleControls (Table 8-11): "
                          "LowPwrAllowRequestHW[6] SquelchMethodSelect[5] "
                          "LowPwrRequestSW[4] SoftwareReset[3]")
    ...
    def _decoded_p11(self,v,i):
        """P11h Decoded: Lane Status & Data Path Status + Lane-Specific Monitors"""
        # ── Data Path States (idx 0~3, 4 bits per lane) ────────────
        if 0<=i<=3:
            hi=(v[i]>>4)&0xF; lo=v[i]&0xF
            _st={1:"LowPwr",2:"PwrUp",3:"Ready",4:"PwrDn",5:"Fault"}
            hs=_st.get(hi,"Rsvd"); ls=_st.get(lo,"Rsvd")
            l1=i*2+2; l2=i*2+1
            return f"L{l1}:{hs} L{l2}:{ls}"
        # ── Lane Output Status (idx 4~5) ───────────────────────────
        if i==4: return f"RxOut=0b{v[4]:08b}"
        if i==5: return f"TxOut=0b{v[5]:08b}"
        # ── Lane Flags (idx 6~22) ──────────────────────────────────
        if 6<=i<=22: return f"0b{v[i]:08b}"
        # ── OpticalPowerTx1~8 (idx 26~41, U16 × 0.1µW → dBm) ─────
        ...
        if 58<=i<=72 and i%2==0:
            lane=(i-58)//2+1
            return f"L{lane}: {uw_to_dbm(u16(v[i],v[i+1]))}"
        # ── ConfigStatus (idx 74~77) ────────────────────────────────
        if 74<=i<=77:
            _cs={0:"Undef",1:"OK",2:"Rejected",0xC:"InProgress"}
            hi=(v[i]>>4)&0xF; lo=v[i]&0xF
            l1=(i-74)*2+2; l2=(i-74)*2+1
            return f"L{l1}:{_cs.get(hi,h2(hi))} L{l2}:{_cs.get(lo,h2(lo))}"
        # ── ACS::DPConfigLane (idx 78~85) ──────────────────────────
        if 78<=i<=85:
            lane=i-77
            app=(v[i]>>4)&0xF; dpid=(v[i]>>1)&7; ec=v[i]&1
            return f"L{lane}: App={app} DPId={dpid} EC={ec}"
        # ── DPInitPending (idx 107) ─────────────────────────────────
        if i==107: return f"0b{v[107]:08b}"
        if i==127: return f"0x{h2(v[127])}"
        return "—"

    def _desc_p11(self,i):
        """P11h Description: Lane Status & Monitors"""
        if 0<=i<=3:
            l1=i*2+2; l2=i*2+1
            return f"DPStateHostLane: Lane{l1}[7:4] Lane{l2}[3:0] — DPState encoding (Table 8-77)"
        if i==4: return "OutputStatusRx: 1=valid Rx output per lane (Table 8-78)"
        if i==5: return "OutputStatusTx: 1=valid Tx output per lane"
        if i==6:  return "LOSFlagTx: Tx Loss of Signal Flag per lane"
        if i==7:  return "LOSFlagRx: Rx Loss of Signal Flag per lane"
        if i==8:  return "CDRLOLFlagTx: Tx CDR Loss of Lock Flag per lane"
        if i==9:  return "CDRLOLFlagRx: Rx CDR Loss of Lock Flag per lane"
        if 10<=i<=17: return f"OpticalPowerHighAlarmFlagTx Lane{i-9}~: Latched Tx optical power high alarm"
        if 18<=i<=21: return f"OpticalPowerLowAlarmFlagTx: Latched Tx optical power low alarm"
        if i==22: return "OutputStatusChangedFlagRx: Latched Rx output status changed flag"
        # Monitors
        if 26<=i<=41 and i%2==0:
            lane=(i-26)//2+1
            return f"OpticalPowerTx{lane}: Tx output optical power, U16×0.1µW (0~6.5535mW, ~-40~+8.2dBm). Adv: 01h:160.1"
        if 42<=i<=57 and i%2==0:
            lane=(i-42)//2+1
            return f"LaserBiasTx{lane}: Tx bias current monitor, U16×2µA×multiplier (01h:160 bits 4:3). Adv: 01h:160.0"
        if 58<=i<=73 and i%2==0:
            lane=(i-58)//2+1
            return f"OpticalPowerRx{lane}: Rx input optical power, U16×0.1µW (0~6.5535mW, ~-40~+8.2dBm). Adv: 01h:160.2"
        if 74<=i<=77:
            return "ConfigStatusLane: 4-bit per lane — 0=Undef 1=OK 2=Rejected Ch=InProgress (Table 8-84)"
        if 78<=i<=85:
            lane=i-77
            return f"ACS::DPConfigLane{lane}: Active Control Set — AppSelCode[7:4] DataPathID[3:1] ExplicitControl[0]"
        if i==107: return "DPInitPending: 1=Data Path init pending for lane (CMIS 5.2 new, 11h:235)"
        if i==127: return "PageChecksum: Bytes 128~254 sum mod256"
        return ""
