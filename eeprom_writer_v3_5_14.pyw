...
CHANGELOG = [
    ("3.5.14","2026-05-11","patch",  "All pages field names & _P02H_DESC updated to CMIS 5.2 official terminology (English)"),
...
_P02H_DESC = {
    0: ("Temp High Alarm Threshold",   "S16/256 °C"),
    2: ("Temp Low Alarm Threshold",    "S16/256 °C"),
    4: ("Temp High Warning Threshold", "S16/256 °C"),
    6: ("Temp Low Warning Threshold",  "S16/256 °C"),
    8: ("Vcc High Alarm Threshold",    "U16×100µV"),
   10: ("Vcc Low Alarm Threshold",     "U16×100µV"),
   12: ("Vcc High Warning Threshold",  "U16×100µV"),
   14: ("Vcc Low Warning Threshold",   "U16×100µV"),
   16: ("Aux1 High Alarm Threshold",   "S16 TEC Current/Custom"),
   18: ("Aux1 Low Alarm Threshold",    "S16 TEC Current/Custom"),
   20: ("Aux1 High Warning Threshold", "S16 TEC Current/Custom"),
   22: ("Aux1 Low Warning Threshold",  "S16 TEC Current/Custom"),
   24: ("Aux2 High Alarm Threshold",   "S16 TEC Current/Laser Temp"),
   26: ("Aux2 Low Alarm Threshold",    "S16 TEC Current/Laser Temp"),
   28: ("Aux2 High Warning Threshold", "S16 TEC Current/Laser Temp"),
   30: ("Aux2 Low Warning Threshold",  "S16 TEC Current/Laser Temp"),
   32: ("Aux3 High Alarm Threshold",   "S16 Laser Temp/Aux Voltage"),
   34: ("Aux3 Low Alarm Threshold",    "S16 Laser Temp/Aux Voltage"),
   36: ("Aux3 High Warning Threshold", "S16 Laser Temp/Aux Voltage"),
   38: ("Aux3 Low Warning Threshold",  "S16 Laser Temp/Aux Voltage"),
   40: ("Custom High Alarm Threshold",   "S16/U16"),
   42: ("Custom Low Alarm Threshold",    "S16/U16"),
   44: ("Custom High Warning Threshold", "S16/U16"),
   46: ("Custom Low Warning Threshold",  "S16/U16"),
   48: ("Tx Power High Alarm Threshold",   "U16×0.1µW→dBm"),
   50: ("Tx Power Low Alarm Threshold",    "U16×0.1µW→dBm"),
   52: ("Tx Power High Warning Threshold", "U16×0.1µW→dBm"),
   54: ("Tx Power Low Warning Threshold",  "U16×0.1µW→dBm"),
   56: ("Tx Bias High Alarm Threshold",   "U16×2µA"),
   58: ("Tx Bias Low Alarm Threshold",    "U16×2µA"),
   60: ("Tx Bias High Warning Threshold", "U16×2µA"),
   62: ("Tx Bias Low Warning Threshold",  "U16×2µA"),
   64: ("Rx Power High Alarm Threshold",   "U16×0.1µW→dBm"),
   66: ("Rx Power Low Alarm Threshold",    "U16×0.1µW→dBm"),
   68: ("Rx Power High Warning Threshold", "U16×0.1µW→dBm"),
   70: ("Rx Power Low Warning Threshold",  "U16×0.1µW→dBm"),
   72: ("Media Lane Tx Power High Alarm Threshold",   "U16×0.1µW→dBm"),
   74: ("Media Lane Tx Power Low Alarm Threshold",    "U16×0.1µW→dBm"),
   76: ("Media Lane Tx Power High Warning Threshold", "U16×0.1µW→dBm"),
   78: ("Media Lane Tx Power Low Warning Threshold",  "U16×0.1µW→dBm"),
   80: ("Media Lane Tx Bias High Alarm Threshold",    "U16×2µA"),
   82: ("Media Lane Tx Bias Low Alarm Threshold",     "U16×2µA"),
   84: ("Media Lane Tx Bias High Warning Threshold",  "U16×2µA"),
   86: ("Media Lane Tx Bias Low Warning Threshold",   "U16×2µA"),
   88: ("Media Lane Rx Power High Alarm Threshold",   "U16×0.1µW→dBm"),
   90: ("Media Lane Rx Power Low Alarm Threshold",    "U16×0.1µW→dBm"),
   92: ("Media Lane Rx Power High Warning Threshold", "U16×0.1µW→dBm"),
   94: ("Media Lane Rx Power Low Warning Threshold",  "U16×0.1µW→dBm"),
   96: ("Reserved", "—"),
  127: ("Page Checksum", "Bytes 128~254 sum mod 256"),
}
...
class App(tk.Tk):
    ...
    def _get_rows(self,pk):
        ...
        if pk=="a0":
            defs=[
                (0,1,"Identifier"),(1,1,"CMIS Revision"),(2,1,"Memory Model"),
                (3,1,"Module State / IntL"),
                (4,1,"IntL Flag Summary Bank0"),(5,1,"IntL Flag Summary Bank1"),
                (6,1,"IntL Flag Summary Bank2"),(7,1,"IntL Flag Summary Bank3"),
                (8,1,"Module Interrupt Flags 1 [CDB/FW]"),
                (9,1,"Module Interrupt Flags 2 [Vcc/Temp]"),
                (10,1,"Module Interrupt Flags 3 [Tx Lane]"),
                (11,1,"Module Interrupt Flags 4 [Rx Lane]"),
                (12,1,"Module Interrupt Flags 5 [Lane Adv]"),
                (13,1,"Module Interrupt Flags 6"),
                (14,2,"Module Temperature"),(16,2,"Supply Voltage"),
                (18,2,"Aux1 Monitor"),(20,2,"Aux2 Monitor"),
                (22,2,"Aux3 Monitor"),(24,2,"Custom Monitor"),
                (26,1,"Module Global Controls"),
                (27,1,"Module Fault Cause"),
                (28,8,"Reserved [0x1C~0x23]"),
                (36,1,"Reserved [0x24]"),
                (37,1,"CDB Status 1"),(38,1,"CDB Status 2"),
                (39,2,"Active FW Version"),
                (41,1,"Lane IntL Flag Summary [Tx]"),
                (42,1,"Lane IntL Flag Summary [Rx]"),
                (43,8,"Tx Fault / Squelch Flags [Lane1~8]"),
                (51,8,"Rx LOS / LOL Flags [Lane1~8]"),
                (59,1,"Reserved [0x3B]"),(60,5,"Reserved [0x3C~0x40]"),
                (65,1,"Tx Disable Status"),(66,1,"Rx Output Disable Status"),
                (67,1,"Tx Forced Squelch Status"),(68,4,"Reserved [0x44~0x47]"),
                (72,8,"Tx Bias Monitor [Lane1~8]"),
                (80,4,"Active DataPath Config [Lane1~4]"),
                (84,1,"Active DataPath Config [Lane5~8]"),
                (85,4,"Application Descriptor [0]"),
                (89,4,"Application Descriptor [1]"),
                (93,4,"Application Descriptor [2]"),
                (97,4,"Application Descriptor [3]"),
                (101,4,"Application Descriptor [4]"),
                (105,4,"Application Descriptor [5]"),
                (109,4,"Application Descriptor [6]"),
                (113,4,"Application Descriptor [7]"),
                (117,8,"DataPath State [Lane1~8]"),
                (125,1,"Reserved [0x7D]"),
                (126,1,"Bank Select"),(127,1,"Page Select"),
            ]
        elif pk=="p00":
            defs=[
                (0,1,"Module Type Identifier"),(1,16,"Vendor Name"),
                (17,3,"Vendor OUI"),(20,16,"Vendor Part Number"),(36,2,"Vendor Revision"),
                (38,16,"Vendor Serial Number"),(54,8,"Date Code"),(62,10,"CLEI Code"),
                (72,1,"Module Power Class"),(73,1,"Max Power"),
                (74,1,"Cable Assembly Length"),(75,1,"Connector Type"),
                (76,8,"Max Media Lane Count [App0~7]"),
                (84,1,"Media Interface Technology"),
                (85,4,"Application Descriptor [0]"),
                (89,4,"Application Descriptor [1]"),
                (93,1,"Reserved [0xDD]"),
                (94,1,"Page Checksum (0xDE)"),
                (95,4,"Application Descriptor [2]"),
                (99,4,"Application Descriptor [3]"),
                (103,4,"Application Descriptor [4]"),
                (107,4,"Application Descriptor [5]"),
                (111,4,"Application Descriptor [6]"),
                (115,4,"Application Descriptor [7]"),
                (119,8,"Reserved [0xF7~0xFE]"),
                (127,1,"Reserved [0xFF]"),
            ]
        elif pk=="p01":
            defs=[
                (0,2,"Inactive FW Version"),(2,2,"Hardware Version"),
                (4,2,"Link Length SMF"),(6,1,"Link Length OM5"),(7,1,"Link Length OM4"),
                (8,1,"Link Length OM3"),(9,1,"Link Length OM2"),
                (10,2,"Nominal Wavelength"),(12,2,"Wavelength Tolerance"),
                (14,1,"Supported Pages Adv."),(15,2,"Duration Advertising"),
                (17,10,"Module Characteristics Adv."),(27,2,"Supported Controls Adv."),
                (29,2,"Supported Flags Adv."),(31,2,"Supported Monitors Adv."),
                (33,2,"Supported SI Controls Adv."),(35,4,"Supported CDB Commands"),
                (39,2,"t_init_time [ms]"),(41,2,"t_reset_time [ms]"),
                (43,2,"t_resetInit_time [ms]"),(45,2,"t_lpInit_time [ms]"),
                (47,2,"t_hpInit_time [ms]"),(49,2,"t_txTurnOn_time [ms]"),
                (51,2,"t_txTurnOff_time [ms]"),
                (53,2,"t_rxTurnOn_time [ms]"),(55,2,"t_rxTurnOff_time [ms]"),
                (57,2,"t_txDisToLos_time [ms]"),(59,4,"CDB Feature Advertising"),
                (63,1,"Reserved [0xBF]"),
                (64,8,"Media Lane Characteristics [Lane1~8]"),
                (72,8,"Media Lane Supported Flags [Lane1~8]"),
                (80,16,"Tx SI Control Advertising"),(96,16,"Rx SI Control Advertising"),
            ...
            defs=[
                (0,2,"Temp High Alarm Threshold"),(2,2,"Temp Low Alarm Threshold"),
                (4,2,"Temp High Warning Threshold"),(6,2,"Temp Low Warning Threshold"),
                (8,2,"Vcc High Alarm Threshold"),(10,2,"Vcc Low Alarm Threshold"),
                (12,2,"Vcc High Warning Threshold"),(14,2,"Vcc Low Warning Threshold"),
                (16,2,"Aux1 High Alarm Threshold"),(18,2,"Aux1 Low Alarm Threshold"),
                (20,2,"Aux1 High Warning Threshold"),(22,2,"Aux1 Low Warning Threshold"),
                (24,2,"Aux2 High Alarm Threshold"),(26,2,"Aux2 Low Alarm Threshold"),
                (28,2,"Aux2 High Warning Threshold"),(30,2,"Aux2 Low Warning Threshold"),
                (32,2,"Aux3 High Alarm Threshold"),(34,2,"Aux3 Low Alarm Threshold"),
                (36,2,"Aux3 High Warning Threshold"),(38,2,"Aux3 Low Warning Threshold"),
                (40,2,"Custom High Alarm Threshold"),(42,2,"Custom Low Alarm Threshold"),
                (44,2,"Custom High Warning Threshold"),(46,2,"Custom Low Warning Threshold"),
                (48,2,"Tx Power High Alarm Threshold"),(50,2,"Tx Power Low Alarm Threshold"),
                (52,2,"Tx Power High Warning Threshold"),(54,2,"Tx Power Low Warning Threshold"),
                (56,2,"Tx Bias High Alarm Threshold"),(58,2,"Tx Bias Low Alarm Threshold"),
                (60,2,"Tx Bias High Warning Threshold"),(62,2,"Tx Bias Low Warning Threshold"),
                (64,2,"Rx Power High Alarm Threshold"),(66,2,"Rx Power Low Alarm Threshold"),
                (68,2,"Rx Power High Warning Threshold"),(70,2,"Rx Power Low Warning Threshold"),
                (72,2,"Lane Tx Power High Alarm Threshold"),(74,2,"Lane Tx Power Low Alarm Threshold"),
                (76,2,"Lane Tx Power High Warning Threshold"),(78,2,"Lane Tx Power Low Warning Threshold"),
                (80,2,"Lane Tx Bias High Alarm Threshold"),(82,2,"Lane Tx Bias Low Alarm Threshold"),
                (84,2,"Lane Tx Bias High Warning Threshold"),(86,2,"Lane Tx Bias Low Warning Threshold"),
                (88,2,"Lane Rx Power High Alarm Threshold"),(90,2,"Lane Rx Power Low Alarm Threshold"),
                (92,2,"Lane Rx Power High Warning Threshold"),(94,2,"Lane Rx Power Low Warning Threshold"),
                (96,31,"Reserved [0xE0~0xFE]"),
                (127,1,"Page Checksum"),
            ]
        elif pk=="p10":
            defs=[
                (0,1,"DataPath Deinit [Lane8:Lane1]"),
                (1,1,"Tx Disable [Lane8:Lane1]"),
                (2,1,"Tx Forced Squelch [Lane8:Lane1]"),
                (3,1,"Tx Polarity Flip [Lane8:Lane1]"),
                (4,1,"Rx Output Disable [Lane8:Lane1]"),
                (5,1,"Rx Output Polarity Flip [Lane8:Lane1]"),
                (6,2,"Reserved [0x8E~0x8F]"),
                (8,1,"Tx Output Amplitude Lane 1"),(9,1,"Tx Output Amplitude Lane 2"),
                (10,1,"Tx Output Amplitude Lane 3"),(11,1,"Tx Output Amplitude Lane 4"),
                (12,1,"Tx Output Amplitude Lane 5"),(13,1,"Tx Output Amplitude Lane 6"),
                (14,1,"Tx Output Amplitude Lane 7"),(15,1,"Tx Output Amplitude Lane 8"),
                (16,1,"Tx Pre-Cursor Lane 1"),(17,1,"Tx Pre-Cursor Lane 2"),
                (18,1,"Tx Pre-Cursor Lane 3"),(19,1,"Tx Pre-Cursor Lane 4"),
                (20,1,"Tx Pre-Cursor Lane 5"),(21,1,"Tx Pre-Cursor Lane 6"),
                (22,1,"Tx Pre-Cursor Lane 7"),(23,1,"Tx Pre-Cursor Lane 8"),
                (24,1,"Tx Post-Cursor Lane 1"),(25,1,"Tx Post-Cursor Lane 2"),
                (26,1,"Tx Post-Cursor Lane 3"),(27,1,"Tx Post-Cursor Lane 4"),
                (28,1,"Tx Post-Cursor Lane 5"),(29,1,"Tx Post-Cursor Lane 6"),
                (30,1,"Tx Post-Cursor Lane 7"),(31,1,"Tx Post-Cursor Lane 8"),
                (32,1,"Rx Input Equalization Lane 1"),(33,1,"Rx Input Equalization Lane 2"),
                (34,1,"Rx Input Equalization Lane 3"),(35,1,"Rx Input Equalization Lane 4"),
                (36,1,"Rx Input Equalization Lane 5"),(37,1,"Rx Input Equalization Lane 6"),
                (38,1,"Rx Input Equalization Lane 7"),(39,1,"Rx Input Equalization Lane 8"),
                (40,1,"Rx CDR Bypass [Lane8:Lane1]"),
                (41,1,"Tx CDR Bypass [Lane8:Lane1]"),
                (42,85,"Reserved [0xAA~0xFE]"),
                (127,1,"Page Checksum"),
            ]
        elif pk=="p11":
            defs=[
                (0,1,"SCS1 AppSel Code Lane 1"),(1,1,"SCS1 AppSel Code Lane 2"),
                (2,1,"SCS1 AppSel Code Lane 3"),(3,1,"SCS1 AppSel Code Lane 4"),
                (4,1,"SCS1 AppSel Code Lane 5"),(5,1,"SCS1 AppSel Code Lane 6"),
                (6,1,"SCS1 AppSel Code Lane 7"),(7,1,"SCS1 AppSel Code Lane 8"),
                (8,1,"SCS1 Data Path Configuration Code Lane 1"),(9,1,"SCS1 Data Path Configuration Code Lane 2"),
                (10,1,"SCS1 Data Path Configuration Code Lane 3"),(11,1,"SCS1 Data Path Configuration Code Lane 4"),
                (12,1,"SCS1 Data Path Configuration Code Lane 5"),(13,1,"SCS1 Data Path Configuration Code Lane 6"),
                (14,1,"SCS1 Data Path Configuration Code Lane 7"),(15,1,"SCS1 Data Path Configuration Code Lane 8"),
                (16,1,"SCS1 Tx Output Amplitude Lane 1"),(17,1,"SCS1 Tx Output Amplitude Lane 2"),
                (18,1,"SCS1 Tx Output Amplitude Lane 3"),(19,1,"SCS1 Tx Output Amplitude Lane 4"),
                (20,1,"SCS1 Tx Output Amplitude Lane 5"),(21,1,"SCS1 Tx Output Amplitude Lane 6"),
                (22,1,"SCS1 Tx Output Amplitude Lane 7"),(23,1,"SCS1 Tx Output Amplitude Lane 8"),
                (24,2,"Reserved [0x98~0x99]"),
                (26,1,"SCS1 Tx Pre-Cursor Lane 1"),(27,1,"SCS1 Tx Pre-Cursor Lane 2"),
                (28,1,"SCS1 Tx Pre-Cursor Lane 3"),(29,1,"SCS1 Tx Pre-Cursor Lane 4"),
                (30,1,"SCS1 Tx Pre-Cursor Lane 5"),(31,1,"SCS1 Tx Pre-Cursor Lane 6"),
                (32,1,"SCS1 Tx Pre-Cursor Lane 7"),(33,1,"SCS1 Tx Pre-Cursor Lane 8"),
                (34,1,"SCS1 Tx Post-Cursor Lane 1"),(35,1,"SCS1 Tx Post-Cursor Lane 2"),
                (36,1,"SCS1 Tx Post-Cursor Lane 3"),(37,1,"SCS1 Tx Post-Cursor Lane 4"),
                (38,1,"SCS1 Tx Post-Cursor Lane 5"),(39,1,"SCS1 Tx Post-Cursor Lane 6"),
                (40,1,"SCS1 Tx Post-Cursor Lane 7"),(41,1,"SCS1 Tx Post-Cursor Lane 8"),
                (42,1,"SCS1 Rx Input Equalization Lane 1"),(43,1,"SCS1 Rx Input Equalization Lane 2"),
                (44,1,"SCS1 Rx Input Equalization Lane 3"),(45,1,"SCS1 Rx Input Equalization Lane 4"),
                (46,1,"SCS1 Rx Input Equalization Lane 5"),(47,1,"SCS1 Rx Input Equalization Lane 6"),
                (48,1,"SCS1 Rx Input Equalization Lane 7"),(49,1,"SCS1 Rx Input Equalization Lane 8"),
                (50,9,"Reserved [0xB2~0xBA]"),
                (59,1,"SCS1 Rx CDR Bypass Lane 1"),(60,1,"SCS1 Rx CDR Bypass Lane 2"),
                (61,1,"SCS1 Rx CDR Bypass Lane 3"),(62,1,"SCS1 Rx CDR Bypass Lane 4"),
                (63,1,"SCS1 Rx CDR Bypass Lane 5"),(64,1,"SCS1 Rx CDR Bypass Lane 6"),
                (65,1,"SCS1 Rx CDR Bypass Lane 7"),(66,1,"SCS1 Rx CDR Bypass Lane 8"),
                (67,60,"Reserved [0xC3~0xFE]"),
                (127,1,"Page Checksum"),
            ]
        else:
            base=0x80
