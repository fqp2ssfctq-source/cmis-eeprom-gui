...
CHANGELOG = [
    ("3.5.10","2026-04-29","patch",  "버그수정: _cmp_dut_loaded 플래그 추가 (_cmp_run DUT 로드 체크)"),
    ("3.5.10","2026-04-29","patch",  "버그수정: 검증 실패 시 _show_page/_update_dirty_label 누락 수정"),
    ("3.5.10","2026-04-29","patch",  "버그수정: CC verify 후 orig_data[94] 동기화 → dirty 잔존 해결"),
    ("3.5.10","2026-04-29","patch",  "버그수정: _verify_write 구버전 A0h만 검증 → inline verify로 통합"),
    ("3.5.10","2026-04-29","major",  "쓰기: write_byte ACK polling 추가 — NVM busy(주소 NACK) 자동 재시도"),
    ("3.5.10","2026-04-29","patch",  "쓰기: write_burst NVM_BYTE_DELAY 제거 (ACK polling으로 대체)"),
